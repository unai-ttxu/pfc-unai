...
\usepackage[pdftex,
    pdfauthor={Pablo Moncada Isla},
            pdftitle={Design and implementation of an administration and search system for a telco services metadirectory },
            pdfsubject={Master Thesis},
            pdfkeywords={Semantic, Linked data, RDF, Scrapping},
            pdfproducer={PDFTex},
...
\include{Appendix-omr}
\include{Appendix-omr-admin}
\include{Appendix-ranking}
